...
//    const MyVerify({Key? key, required this.email}) : super(key: key);

//   @override
//   State<MyVerify> createState() => _VerificationState();
// }

// class _VerificationState extends State<MyVerify> {
...
//                                  return  NewPassword(email: widget.email, otp:value.text);
//                           },)); 
//                       },
